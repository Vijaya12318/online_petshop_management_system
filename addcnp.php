                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown active"><a class="dropdown-toggle wow fadeInDown" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th"></span> Product <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                              <li><a href="addcnp3.php"> Add_DOGS_Product</a></li>
                              <li><a href="addcnp1.php"> Add_CATS_Product</a></li>
                              <li><a href="addcnp2.php"> Add_BIRDS_Product</a></li>
                              <li><a href="addcnp3_food.php"> Add_DOGS_FOOD_Product</a></li>
                              <li><a href="addcnp1_food.php"> Add_CATS_FOOD_Product</a></li>
                              <li><a href="addcnp2_food.php"> Add_BIRDS_FOOD_Product</a></li>
                            </ul>
                        </li>
...
<?php 
    include('includes/rules_for_add&update_products.php');
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2022 <a target="_blank" href="#" title="#">Petshop Online Websit</a>.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
