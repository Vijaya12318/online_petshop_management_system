                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown active"><a class="dropdown-toggle wow fadeInDown" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th"></span> Product <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                              <li><a href="update_cnp.php"> Update_DOGS_Product</a></li>
                              <li><a href="update_cnp1.php"> Update_CATS_Product</a></li>
                              <li><a href="update_cnp2.php"> Update_BIRDS_Product</a></li>
                              <li><a href="update_cnp_food.php"> Update_DOGS_FOOD_Product</a></li>
                              <li><a href="update_cnp1_food.php"> Update_CATS_FOOD_Product</a></li>
                              <li><a href="update_cnp2_food.php"> Update_BIRDS_FOOD_Product</a></li>
...
<?php 
    include('includes/updateavailables_birds_food.php');
