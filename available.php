...
<head>
	...
	position:relative;
	width:100%;
	background-image:linear-gradient(to top right,rgba(0,0,0,0.8),rgba(0,0,0,0.5)),url(dc2.jpg);
...
<section class="hero_main">
    ...
    <br>
     <!--<h1> SAY HI TO NATURE.<br> WHICH IS BEYOUND SCIENCE<h1>-->
         <ul>
	<li> <a href="pets_types.php" class="btn btn-take"  style="font-size:30px; ">PETS</a></li><br><br><br>
	 <li><a href="food_products.php" class="btn btn-more" style="font-size:30px;">FOOD _PRODUCTS_FOR_PETS</a></li>
    </ul>
    </div>
...
<div class="backimg">
    <div style="font-size:30px; font-family:verdana; font-weight:bold; color: #8B8B00; text-align:center;">Product</div>
        <p style="text-align:center; font-family:verdana;"><br></p>
            ...
            <ul>
           <li><a href="pets_types.php" class="btn btn-success btn-sm pull-center wow fadeInDown" style="font-size:30px; background-image: url('images/7.jpeg');">PETS</a></li><BR>

            <li><a href="food_products.php" class="btn btn-success btn-sm pull-down wow fadeInDown" style="font-size:30px;">FOOD _PRODUCTS_FOR_PETS </a></li>
            </ul>
    </div> 
    </section>-->
