...
<section id="tour-packages" class="center wow fadeInDown">
    <div style="font-size:30px; font-family:verdana; font-weight:bold; color: #8B8B00; text-align:center;">avaliable cats food products</div>
        <p style="text-align:center; font-family:verdana;"><br></p>


        <div class="container" style="height:400px;">
			<iframe src="availableframe_cats_food.php" width="100%;" height="400px;" style="border-style:none;"><button>cats food</button></iframe>
